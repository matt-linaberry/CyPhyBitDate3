...
private let ref = Firebase(url: "https://cyphybitdate.firebaseio.com/messages")
...
func fetchMessages(matchID: String, callback: ([Message]) -> ()) {
    ref.childByAppendingPath(matchID).queryLimitedToFirst(25) // limit the results we get back.
